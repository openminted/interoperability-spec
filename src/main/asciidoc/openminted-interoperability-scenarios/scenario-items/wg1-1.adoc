...
They have come across similar situations and know how important description is important for resource discovery, especially when it involves different resource types.
