...
| Alvis
| Partial
| Alvis uses a shared data structure, the workflow engine is required to manage the data and the modules during the execution steps. However each module can be encapsulated with the Alvis engine.
| draft
