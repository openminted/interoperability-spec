...
| June-16
| No
| The link:http://vocab.lappsgrid.org[LAPPS Web Service Exchange Vocabulary] does not specify any metadata elements relating to domain/subject classification.
| Draft
|====
