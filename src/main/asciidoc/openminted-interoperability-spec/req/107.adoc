...
| June-16
| No
| The link:http://vocab.lappsgrid.org[LAPPS Web Service Exchange Vocabulary] does not specify any metadata elements relating to domain/subject classification, and neither does the LAPPS web site give a description of that domain, beyond saying that it is for linguistic data.
| Draft
|====
