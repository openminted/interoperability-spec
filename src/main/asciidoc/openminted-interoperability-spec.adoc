...
* How difficult is it be to a new technology or standard be incorporated into the platform?
* How difficult is to integrate new components based on already supported technologies and standards
  into the platform.
...
but if does not use the metadata format prescribed by the concrete requirement, it is not compliant
here. The product may attain thus attain *silver* compliance on the abstract level, but *no* overall
